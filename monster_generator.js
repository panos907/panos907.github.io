...
let monsterActions = {
    ...
    "Ghoul":'Bite: Melee Attack: + Combat Modifier, Reach 1 square, 1 target. Damage: 1D10 +(STR) + Combat Modifier. Claw: Melee Attack: + Combat Modifier, Reach 1 square, 1 target. Damage: 2D4 +(STR) + Combat Modifier',
    "Zombie":'Bite: Melee Attack + Combat Modifier, Reach 1 square, 1 target. Damage: 1D8 +(STR) + Combat Modifier. Slam. Melee Attack: + Combat Modifier, Reach 1 square, 1 target. Damage: 1D4 +(STR) + Combat Modifier',
    "Bandit":'BroadSword: Melee Attack + Combat Modifier, Reach 1 square, 1 target. Damage 1D8 +(STR) + Combat Modifier.'
}
